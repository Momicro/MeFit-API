...
public class ExerciseController {
    ...
    public Set<MuscleGroup> getAllMuscleGroupsOfExercise(@PathVariable(value = "id") long exerciseId) {
    ...
    /*
        ...
        public ResponseEntity<Exercise> updateExerciseMuscleGroup(@PathVariable(value="id") long exerciseId,
                                                       @RequestBody int[] muscleGroupIds) {

            Exercise exercise = exerciseRepository.findById(exerciseId).get();

            return ResponseEntity.ok(
                    this.exerciseService.updateExerciseMuscleGroup(muscleGroupIds, String.valueOf(exerciseId)));
        }
    */
    ...
    public Set<MuscleGroup> getMuscleGroupsOfExercise(@PathVariable(value="id") long exerciseId) {
